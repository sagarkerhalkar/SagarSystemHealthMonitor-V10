...
$routes = @("/","/v10_inventory_plugin.js","/v10_inventory_plugin.css","/api/health","/api/overview","/api/machines","/api/v10/status","/api/v10/current-machines","/api/v10/software-inventory","/api/v10/gpu-inventory","/api/v10/hardware-inventory","/api/v10/usb-inventory","/api/export/machine_current.csv","/api/export/software.csv","/api/export/usb.csv","/api/export/gpu.csv","/api/export/hardware.csv")
foreach ($r in $routes) {
...
Write-Host "V10 OLD UI PLUGIN REAL MERGE QA OK" -ForegroundColor Green
