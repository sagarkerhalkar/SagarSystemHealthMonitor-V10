...
## Project source chat lock â€” 2026-06-29

Latest V10 identity, hardware, GPU, and H/W inventory integration status is locked in:

PROJECT_SOURCE_CHAT_LOCK_2026_06_29.md

Important: recover blank V10 dashboard first, then integrate H/W Inventory into the existing main dashboard left menu. Do not use the old floating Inventory / ISO modal.

## V10 Next Toppers UI/UX Requirement Lock
Applied: 20260702_171941
- V10 UI uses Next Toppers branding and company website https://www.nexttoppers.com/.
- Source requirement file: docs/V10_UI_UX_REQUIREMENTS_LOCKED_NEXTTOPPERS.md
- Main 2278 is not touched.
- Notification backend locked rules must not be disturbed.
- UI must stay responsive for mobile/tablet/iPad/Apple/laptop/browser and pass test scripts.


## V10 Next Toppers UI Fix2 Real Data Lock
- Readable fonts, login animation, deploy center, active notifications, retention days setting. Main 2278 untouched.


## V10 Locked Requirements
See docs/V10_LOCKED_REQUIREMENTS_AND_ROADMAP.md. This file is the source-of-truth for V10 delivery. Do not rely only on chat memory.
